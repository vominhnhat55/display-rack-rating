...
export default function HomePage() {
  ...
  return (
    <div className='relative'>
      ...
      <span
        className='absolute -top-2 right-6 text-5xl beach-float select-none pointer-events-none'
        style={{animationDelay: '0s'}}
      >
        ☀️
      </span>
      <span
        className='absolute top-16 -left-2 text-3xl beach-float-slow select-none pointer-events-none'
        style={{animationDelay: '0.5s'}}
      >
        🌴
      </span>
      <span
        className='absolute top-36 right-0 text-2xl beach-float-mid select-none pointer-events-none'
        style={{animationDelay: '1s'}}
      >
        🐚
      </span>
      <span
        className='absolute bottom-24 -left-1 text-2xl beach-float select-none pointer-events-none'
        style={{animationDelay: '1.5s'}}
      >
        🌊
      </span>
      <span
        className='absolute bottom-20 right-4 text-xl beach-float-slow select-none pointer-events-none'
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(90deg,#38bdf8,#06b6d4,#0ea5e9,#67e8f9,#38bdf8)',
          }}
        />
        ...
        <div className='absolute inset-0 overflow-hidden pointer-events-none opacity-[0.04]'>
          ...
          >
            <path
              d='M0,200 C100,120 200,280 300,200 C400,120 500,280 600,200 C700,120 800,280 800,200 L800,400 L0,400 Z'
              fill='#0ea5e9'
            />
            <path
              d='M0,280 C133,200 267,360 400,280 C533,200 667,360 800,280 L800,400 L0,400 Z'
              fill='#0284c7'
            />
          </svg>
        </div>
        ...
        <div className='relative px-6 pb-6 pt-4'>
          ...
          <div className='flex justify-center mb-4'>
            <span
              className='inline-flex items-center gap-2 text-xs font-bold px-5 py-1.5 rounded-full text-white shadow-lg'
              style={{
          ...
          <div className='flex w-full justify-center'>
            <div className='relative'>
              <div
                ...
                style={{
                  background:
                    'radial-gradient(circle,#fde68a,#fb923c,transparent)',
                }}
              />
              <Image
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(90deg,#0284c7,#06b6d4,#38bdf8,#67e8f9,#0284c7)',
          }}
        />
      </section>
      ...
      <div className='flex justify-center mt-5 gap-5 text-2xl select-none pointer-events-none'>
        <span className='beach-float opacity-70' style={{animationDelay: '0s'}}>
          🌊
        </span>
        <span
          className='beach-float-slow opacity-60'
          style={{animationDelay: '0.4s'}}
        >
          🏖️
        </span>
        <span
          className='beach-float-mid opacity-70'
          style={{animationDelay: '0.8s'}}
        >
          🐠
        </span>
        ...
        <span
          className='beach-float opacity-70'
          style={{animationDelay: '1.6s'}}
        >
          ⭐
        </span>
        <span
          className='beach-float-mid opacity-60'
